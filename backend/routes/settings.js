...
router.put('/', async (req, res, next) => {
  try {
    ...
    const row = {
      ...
      basic_vehicle_driver_observed_threshold:   clamp(b.basicVehicleDriverObservedThreshold,   D.basicVehicleDriverObservedThreshold,   1, 100),
      basic_vehicle_driver_observed_action:      oneOf(b.basicVehicleDriverObservedAction,      D.basicVehicleDriverObservedAction,      ['reject','hold']),
      basic_hazmat_threshold:                    clamp(b.basicHazmatThreshold,                  D.basicHazmatThreshold,                  1, 100),
      basic_hazmat_action:                       oneOf(b.basicHazmatAction,                     D.basicHazmatAction,                     ['reject','hold']),
      ...
      oos_hard_block_truck:                      floatMin(b.oosHardBlockTruck,   D.oosHardBlockTruck,   1),
      oos_hard_block_driver:                     floatMin(b.oosHardBlockDriver,  D.oosHardBlockDriver,  1),
      inspection_volume_min:                     posInt(b.inspectionVolumeMin,   D.inspectionVolumeMin),
