...
export function rowToCfg(row) {
  ...
  return {
    ...
    basicVehicleDriverObservedThreshold:    row.basic_vehicle_driver_observed_threshold,
    basicVehicleDriverObservedAction:       row.basic_vehicle_driver_observed_action,
    basicHazmatThreshold:                   row.basic_hazmat_threshold,
    basicHazmatAction:                      row.basic_hazmat_action,
    ...
    oosHardBlockTruck:                      row.oos_hard_block_truck,
    oosHardBlockDriver:                     row.oos_hard_block_driver,
    inspectionVolumeMin:                    row.inspection_volume_min,
  };
}
